            ...
            <div class="p-2 bg-white rounded-tl-lg rounded-tr-lg">
                <div class="flex items-center justify-between">
                    <h2 class="p-1 text-lg md:text-lg text-black font-normalleading-tight flex items-center justify-start">
                        {{ __('Tableau de bord de coordination Générale technique') }}
                    </h2>
                </div>
            </div>
        </div>
            ...
            <div class="flex flex-col">
                <div class="-mx-4 -my-2 overflow-x-auto overflow-auto sm:-mx-6 lg:-mx-8">
                    <div class="flex justify-start gap-3 px-1 lg:px-4">
                        ...
                        {{-- =================================================================================================== --}}
                        <span class="mb-5 pb-5 ml-5 mt-5">
                            <a href="{{route('decision_tech.done')}}" title="Créer ici..">
                                <button class="flex items-center px-2 py-1 text-sm tracking-wide text-color_rej transition-colors duration-200 bg-yellow-500 rounded-lg shrink-0 sm:w-auto gap-x-1 hover:bg-ventis_color">
                                    <p>Décision</p>
